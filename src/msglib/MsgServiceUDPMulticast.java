...
public class MsgServiceUDPMulticast implements IMsgService {
	 ...
	 * 
	 * @param udpMulticastNet es: "224.0.0.1"
	 * @throws Exception
	 */
	 ...
	 * @param udpMulticastNet udp multicast address
	 */
	...
	public void sendMsg(String msg) throws Exception {
       ...
       DatagramPacket dp = new DatagramPacket(msg1.getBytes(), msg1.length(), group, 20001);
       ms.send(dp);				
	}	
	...
	public Msg receiveMsg(MsgPattern pattern) throws Exception {
		while (true) {
		    ...
		    // System.out.println("> "+sender+" received from "+who);
		    if (!sender.equals(owner)){
		    	if ((receiver.equals(ANY) || receiver.equals(owner)) && pattern.match(m)){
		    		return m;
		    	}
		    }
		}
